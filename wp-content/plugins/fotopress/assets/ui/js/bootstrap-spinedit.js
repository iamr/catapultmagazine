...
!function (jQuery) {
    ...
    var SpinEdit = function (element, options) {
        ...
        template.find('.glyphicon-chevron-up').mousehold(jQuery.proxy(this.increase, this));
        template.find('.glyphicon-chevron-down').mousehold(jQuery.proxy(this.decrease, this));
